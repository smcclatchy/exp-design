...
<img src="../fig/rmd-06-qq_plot-1.png" title="plot of chunk qq_plot" alt="plot of chunk qq_plot" style="display: block; margin: auto;" />
...
Residuals:
    Min      1Q  Median      3Q     Max 
-1.0358 -0.7368 -0.3318  0.3529  5.7158 

Coefficients:
            Estimate Std. Error t value Pr(>|t|)    
(Intercept)  0.95038    0.13435   7.074 4.22e-12 ***
x            0.04290    0.08497   0.505    0.614    
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1

Residual standard error: 1.041 on 598 degrees of freedom
Multiple R-squared:  0.0004262,	Adjusted R-squared:  -0.001245 
F-statistic: 0.255 on 1 and 598 DF,  p-value: 0.6138
~~~
{: .output}

Notice that the slope (Estimate column) is near zero (0.042904), indicating no relationship between the two variables.
...
<img src="../fig/rmd-06-bad_model_hist-1.png" title="plot of chunk bad_model_hist" alt="plot of chunk bad_model_hist" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-bad_model_v_good-1.png" title="plot of chunk bad_model_v_good" alt="plot of chunk bad_model_v_good" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-histogram2-1.png" title="plot of chunk histogram2" alt="plot of chunk histogram2" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-qq_plot2-1.png" title="plot of chunk qq_plot2" alt="plot of chunk qq_plot2" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-resid_vs_fitted2-1.png" title="plot of chunk resid_vs_fitted2" alt="plot of chunk resid_vs_fitted2" style="display: block; margin: auto;" />
