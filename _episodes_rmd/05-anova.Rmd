...
Note the values for the F-statistic and the R-squared. Also notice that the slope (Estimate column) is near zero (`r round(bad_model$coefficients[[2]], digits = 6)`), indicating no relationship between the two variables.
